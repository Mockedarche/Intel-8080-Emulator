...
use std::{collections::btree_map::Range, io::Write};
...
fn run_test(s: &str) {
    ...
    let mut load_rom_result = core.i8080_load_rom(s, 0x0100);
    ...
    let mut step_result = StepInstructionResult::Ok;
